...
var SignaturePad = (function(document) {
    ...
    SignaturePad.prototype.clears = function() {
        var ctx = this._ctx,
            canvas = this._canvas;
...
var saveButton = document.getElementById('save'),
    ...
    clearButtons = document.getElementById('clears'),

    showPointsToggle = document.getElementById('showPointsToggle');

saveButton.addEventListener('click', function(event) {
    var data = signaturePad.toDataURL('image/png');
    document.getElementById("authorized_vet_signature").value = data;
...
// saveButton.addEventListener('click', function(event) {
//     var datas = signaturePad.toDataURL('image/png');
//     document.getElementById("authorized_vetnurse_signature").value = datas;
//     document.sign_frm.submit();
...
clearButtons.addEventListener('click', function(event) {
    signaturePad.clears();
});
